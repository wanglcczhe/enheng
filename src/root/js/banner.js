;(function($){
    ...
    $.fn.banner = function(options){
        ...
        let move = function (direct){
            ...
            if(list){
                $(".list").children().eq(iPrev).css({background:""}).end().eq(index).css({background:"#ffbe22"});
            }
        ...
        if(list){
            ...
            $(".list").children("li").click(function(){
                ...
                // L6.设置list的当前项
                $(".list").children("li").eq(index).css({background:"#fff"}).end().eq($(this).index()).css({background:"#ffbe22"}).end().siblings().css({background:"#fff"})
